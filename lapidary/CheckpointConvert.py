...
class GDBCheckpointConverter:
    ...
    def __init__(self, gdb_checkpoint, is_smt):
...
def convert_checkpoint(gdb_checkpoint, force_recreate, is_smt):
    assert isinstance(gdb_checkpoint, GDBCheckpoint)

    converter = GDBCheckpointConverter(gdb_checkpoint, is_smt)
