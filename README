...
To install the necessary prequisites for DOLMA/gem5, run `./install_dependencies.sh`
from the repo's top level directory (requires sudo, tested on Ubuntu 20.04).
